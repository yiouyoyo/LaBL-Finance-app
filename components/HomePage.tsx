...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#ebeef2' }}>
      ...
      <main className="px-6 py-12 sm:px-8 md:px-12 md:py-20">
        <div className="max-w-6xl mx-auto space-y-16">
          <CorporateCardRecords />

          <section className="editorial-surface rounded-xl border p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button onClick={() => setSubmissionType('corporate')} className="editorial-choice text-left p-5 rounded-lg border transition-all">
                <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#32317a' }}>01</p>
                <h3 className="text-lg font-semibold mt-3" style={{ color: '#32317a' }}>Corporate Card</h3>
                <p className="text-sm mt-1" style={{ color: '#4a5568' }}>Submit an invoice and upload the original proof file.</p>
              </button>
              <button onClick={() => setSubmissionType('reimbursement')} className="editorial-choice text-left p-5 rounded-lg border transition-all">
                <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#32317a' }}>02</p>
                <h3 className="text-lg font-semibold mt-3" style={{ color: '#32317a' }}>Reimbursement</h3>
                <p className="text-sm mt-1" style={{ color: '#4a5568' }}>Complete the reimbursement form using your own funds.</p>
              </button>
            </div>
          </section>

          <section className="editorial-surface rounded-xl border p-6 sm:p-8" style={{ borderLeft: '4px solid #efa4a4' }}>
          ...
          <section className="editorial-surface rounded-xl border p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button onClick={() => setShowMoreForms(true)} className="editorial-choice text-left p-4 rounded-lg border transition-all">
              ...
              <div className="p-4 rounded-lg border" style={{ borderColor: 'rgba(149, 210, 235, 0.3)', backgroundColor: 'rgba(149, 210, 235, 0.12)' }}>
